...
Program ID- 2712
Solved By 1037
Users Two Policemen Catching a Thief Policeman1 and Policeman2 along with a thief are standing on X-axis.
The integral value of their location on the X-axis is passed as the input.
...
Output Format: The first line will contain one of the following values - Police1, Police2, Both
